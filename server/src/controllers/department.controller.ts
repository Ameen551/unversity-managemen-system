...
export const createDepartment = asyncHandler(async (req: Request, res: Response) => {
  ...
  if (existing) throw errors.conflict(`A department with code "${data.code}" already exists.`);
...
export const updateDepartment = asyncHandler(async (req: Request, res: Response) => {
  ...
  if (data.code) {
    ...
    if (clash) throw errors.conflict(`A department with code "${data.code}" already exists.`);
  }
