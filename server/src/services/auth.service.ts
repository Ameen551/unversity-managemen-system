...
export function setRefreshCookie(res: { cookie: (n: string, v: string, o: object) => void }, token: string): void {
...
export function clearRefreshCookie(res: { clearCookie: (n: string, o: object) => void }): void {
