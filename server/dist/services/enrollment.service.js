 ...
 */
export async function autoEnrollSubject(subjectId, departmentId, sessionId, semesterId) {
...
export async function autoEnrollStudent(studentId, departmentId, sessionId, semesterId) {
